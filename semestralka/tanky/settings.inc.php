...
const WEB_PAGES = [
    ...
    "novyTank" => array("file" => "pridat_tank_controller.class.php", "object" => "PridatTankController", "title" => 
    "Nový tank"),
    "novaMapa" => array("file" => "pridat_mapu_controller.class.php", "object" => "PridatMapuController", "title" => 
    "Nová mapa")
];
