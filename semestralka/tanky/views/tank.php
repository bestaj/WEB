<?php
// Sablona pro stranku s jednim tankem
...
?>  
    <div class="myContainer">
        <div class="itemPanel">
            ...
            <!-- Vypis vlastnosti konkretniho tanku -->
            <table>
            ...
            ?>
            <!-- Zobrazeni hodnoceni daneho tanku -->
            <div class="rating">
                <table>
            ...
            ?>
            <!-- Moznost hodnoceni tanku pro prihlaseneho uzivatele -->
                ...
                <div id="ratePanel" class="collapse">
                    <table>
                        <form id="rate" action="index.php?page=tank" method="post">
                            <tr><td></td><td id="rateInfo">(0 - 10) 0=nejhorší, 1=nejlepší</td></tr>
                            <tr><td>Přesnost děla:</td><td><input type="number" name="presnost" min="0" max="10" size="1" step="1"></td></tr> 
                            <tr><td>Rychlost nabíjení:</td><td><input type="number" name="nabijeni" min="0" max="10" size="1" step="1"></td></tr>
